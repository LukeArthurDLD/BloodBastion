...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Jump()
    {
        ...
        if (isGrounded)
        {
            ...
            //rb.AddForce(new Vector3(0, jumpPower, 0) * rb.mass * 2.5f);
            isGrounded = false;
        }
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        #region Player Health Setup
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Player Health Setup", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));
        EditorGUILayout.Space();

        fpc.playerHealth = EditorGUILayout.Slider(new GUIContent("Player Health", "Determines the amount of Health the Player will have."), fpc.playerHealth, 0f, 100f);
        EditorGUILayout.Space();
        #endregion
        ...
        EditorGUILayout.Space();
        fpc.walkingAudioSource = (AudioSource)EditorGUILayout.ObjectField(new GUIContent("Audio Source"), fpc.walkingAudioSource, typeof(AudioSource), true);
